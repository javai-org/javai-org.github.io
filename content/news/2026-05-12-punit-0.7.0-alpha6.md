...
The migration is mechanical. The CHANGELOG entry on the [punit release](https://github.com/javai-org/punit/blob/main/CHANGELOG.md#070-alpha6---2026-05-12) carries the full find-and-replace recipe. Summary:
...
[`punitexamples`](https://github.com/javai-org/punitexamples) renames in lockstep — `ShoppingBasketServiceContract`, `PaymentGatewayServiceContract` — and ships as `org.javai:punit-examples:0.5.0-alpha6` on Maven Central. The example sources are the easiest way to see how the new name reads in author-facing code.
...
- [GitHub release](https://github.com/javai-org/punit/releases/tag/v0.7.0-alpha6)
- [Maven Central — `org.javai:punit:0.7.0-alpha6`](https://central.sonatype.com/artifact/org.javai/punit/0.7.0-alpha6)
- [punit examples 0.5.0-alpha6](https://central.sonatype.com/artifact/org.javai/punit-examples/0.5.0-alpha6)
