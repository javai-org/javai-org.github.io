...
The software profession has spent those same decades learning to build, without learning to characterise with statistical rigour what it has built. With deterministic systems, there was no need. With seemingly-deterministic systems - network calls, latency, concurrency - it got away with it. With probabilistic ones, it will not.
...
| [Jeffrey Liker, *The Toyota Way*](https://en.wikipedia.org/wiki/The_Toyota_Way)                                                                                                                     | Contemporary reference for the Toyota Production System as a continuously-instrumented manufacturing process.                                                 |
