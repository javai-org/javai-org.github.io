...
The executive is up against powerful forces. Boards that do not understand software quality hire CEOs who do not prioritise it. Investors on quarterly cycles punish costs that buy maintainability if it's at the expense of velocity. Parent companies will impose throughput targets with no notion of what the throughput is costing. 
...
The juniors will not save us. The AI will not save us. The seniors, in too many organisations, cannot. The lever is, and always was, further up — and the quiet opportunity of this moment is that AI has made its position impossible to hide.
